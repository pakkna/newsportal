...
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <label class="control-label">Reporter Name
            </label>
            <input type="text" class="form-control" name="rp_name" placeholder="Reporter Name"
                   value="<?php echo html_escape($post->rp_name); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
        </div>
