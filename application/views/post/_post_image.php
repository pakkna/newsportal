...
<?php if (!empty($post_item) && !empty($type)): ?>
    ...
    <?php else: ?>
        ...
        <?php else: ?>
            <img src="<?php echo get_post_image($post_item, $image_size); ?>" data-src="<?php echo get_post_image($post_item, $image_size); ?>" alt="<?php echo html_escape($post_item->title); ?>" class="lazyload img-responsive img-post"/>
        <?php endif; ?>
    <?php endif; ?>
